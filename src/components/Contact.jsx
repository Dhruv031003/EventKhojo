...
function Contact() {
  return (
    <section className="bg-white">
      <div className="container px-8 mx-auto my-2">
          ...
          <div className="lg:w-1/2 lg:mx-6">
            ...
            <div className="mt-6 space-y-8 md:mt-8">
              <p className="flex items-start -mx-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-[#DD3F22]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
